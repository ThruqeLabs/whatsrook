// WebP image processing – encode, decode, and manipulate WebP images and WhatsApp sticker EXIF metadata.
package media
...
// WriteStickerMetadata modifies sticker metadata on a file and saves with .metadata.webp extension.
