...
func (s *CallSession) TransitionTo(next CallPhase) bool {
	...
	case s.phase == CallPhaseRinging && next == CallPhaseConnecting:
		ok = true
	// Source of truth: https://github.com/purpshell/wacaller/blob/f62ccfb2a431fc25008423954287fd3009fed161/datasheets/web-initial-group-call.md#L40-L120
...
func (p *MediaPipeline) RekeySendFromRaw(rawE2E []byte, selfJID string) error {
	// Source of truth: https://github.com/purpshell/wacaller/blob/cbe1446dabb5842362b1a4362d4100ec15d8254f/datasheets/group-media-key-epoch.md#L56-L64
...
func (p *MediaPipeline) installSendKeys(sendKeys srtp.E2eSrtpKeys) {
	// Source of truth: https://github.com/purpshell/wacaller/blob/cbe1446dabb5842362b1a4362d4100ec15d8254f/datasheets/group-media-key-epoch.md#L122-L136
	p.sendMu.Lock()
	p.sendKeys = sendKeys
	p.sendMu.Unlock()
}
