...
// of start-code-prefixed NAL units). wacaller does not encode or decode pixels — an
// external codec (the browser's WebCodecs, a hardware encoder, ffmpeg, …) produces and
// consumes the H.264; wacaller carries it over the WhatsApp relay. The send/receive model
