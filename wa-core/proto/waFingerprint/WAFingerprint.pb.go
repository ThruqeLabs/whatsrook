...
const file_waFingerprint_WAFingerprint_proto_rawDesc = "" +
	"\n" +
	"!waFingerprint/WAFingerprint.proto\x12\rWAFingerprint\"\xc9\x01\n" +
	...
	"\x11remoteFingerprint\x18\x03 \x01(\v2\x1e.WAFingerprint.FingerprintDataR\x11remoteFingerprint\"\x91\x02\n" +
	...
	"\x0fhashedPublicKey\x18\x06 \x01(\fR\x0fhashedPublicKey*#\n" +
	"\vHostedState\x12\b\n" +
	"\x04E2EE\x10\x00\x12\n" +
	"\n" +
...
var file_waFingerprint_WAFingerprint_proto_goTypes = []any{
	...
	(*CombinedFingerprint)(nil), // 1: WAFingerprint.CombinedFingerprint
	(*FingerprintData)(nil),     // 2: WAFingerprint.FingerprintData
}
var file_waFingerprint_WAFingerprint_proto_depIdxs = []int32{
	2, // 0: WAFingerprint.CombinedFingerprint.localFingerprint:type_name -> WAFingerprint.FingerprintData
	2, // 1: WAFingerprint.CombinedFingerprint.remoteFingerprint:type_name -> WAFingerprint.FingerprintData
	0, // 2: WAFingerprint.FingerprintData.hostedState:type_name -> WAFingerprint.HostedState
