...
func ParseGroupUpdate(node *waBinary.Node) (*GroupCallUpdate, error) {
	// Source of truth: https://github.com/purpshell/wacaller/blob/68f039c1d44407788d543f2a510afd550c25591c/datasheets/voip-group-update-ingest.md#L20-L78
...
func BuildGroupEncRekey(params GroupEncRekeyParams) (waBinary.Node, error) {
	// Source of truth: https://github.com/purpshell/wacaller/blob/d9df3eb9d96ea5260ffcd4036b6669499a1c1bc2/datasheets/voip-group-key-epoch-fanout.md#L20-L72
	if params.CallID == "" || params.To.IsEmpty() || params.CallCreator.IsEmpty() ||
...
func ParseGroupCallEncRekey(node *waBinary.Node) (*GroupCallEncRekey, error) {
	// Source of truth: https://github.com/purpshell/wacaller/blob/747c6a1b8a0370358ef18bbaa5e029b960c2f836/datasheets/voip-group-enc-rekey-ingest.md#L39-L65
