...
import (
	...
	"wa-core/proto/waAdv"
	"wa-core/store"
	"wa-core/store/sqlstore/upgrades"
	"wa-core/types"
	"wa-core/util/keys"
...
func (c *Container) Upgrade(ctx context.Context) error {
	...
	// Best-effort column addition to ensure whatsmeow_contacts always has username column
	_, _ = c.db.Exec(ctx, "ALTER TABLE whatsmeow_contacts ADD COLUMN username TEXT")
	return nil
}
